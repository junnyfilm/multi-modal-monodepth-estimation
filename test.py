...
def main():
    ...
    args.data_path = '/home/ayoung/MIM/GLPDepth/dataset'
    args.max_depth = 10.0
    args.max_depth_eval = 10.0
    args.backbone = 'swin_large_v2'
    args.depths = [2,2,18,2]
    args.num_filters = [32,32,32]
    args.deconv_kernels = [2,2,2]
    args.window_size = [30,30,30,15]
    args.pretrain_window_size = [12,12,12,6]
    args.use_shift = [True,True,False,False]
    args.shift_size = 2
    args.ckpt_dir = '/home/ayoung/MIM/MIM-Depth-Estimation/ckpt/nyudepthv2_swin_base.ckpt'
    ...
    for batch_idx, batch in enumerate(test_loader):
        ...
        # print('cuda',input_RGB)
        # print('cuda',input_RGB.type()) #torch.cuda.FloatTensor
        # print('cuda',input_RGB.shape) #torch.Size([1, 3, 480, 640])
