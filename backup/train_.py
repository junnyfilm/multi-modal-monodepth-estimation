...
def main():
    ...
    args.dataset =  'void' #'nyudepthv2'
     # release data path
    args.data_path = '/media/ayoung/AY T5 1TB ntfs/void_dataset_custom' 
    #'/home/ayoung/void-dataset-all/void-dataset/data/void_release/void_1500/data'
    args.max_depth = 10.0
    ...
    args.shift_size = 2
    args.pretrained = '/home/ayoung/MIM/MIM-Depth-Estimation/ckpt/nyudepthv2_swin_base.ckpt'
    args.crop_h = 480
    args.crop_w = 480
    args.layer_decay = 0.85
